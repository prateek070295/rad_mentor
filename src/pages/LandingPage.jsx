  ...
  <section id="problems" className="bg-white">
    <div className="container mx-auto px-4 sm:px-6 py-14">
      ...
      <div className="mt-10 grid md:grid-cols-3 gap-6">
        {[{
          icon: "📚", title: "Vast Syllabus", text: "Feeling overwhelmed trying to cover the vast DNB theory syllabus while managing intense clinical work?",
        }, {
          icon: "📅", title: "Unpredictable Schedule", text: "Struggling to follow a fixed schedule due to unpredictable duties, leaving massive backlogs before exam leave?",
        }, {
          icon: "❓", title: "Lack of Guidance", text: "Unsure if you’re focusing on the right topics or how to track your progress against the entire syllabus?",
        }].map((p, idx) => (
    ...
    <div className="container mx-auto px-4 sm:px-6 py-14">
      ...
      <div className="mt-10 grid lg:grid-cols-3 gap-6">
        {[{
          ...
          desc: "Manage the reality of residency. Drag and drop topics, adjust for heavy on‑call days, and ensure you’re consistently making progress towards your DNB goal.",
        }, {
    ...
    <div className="container mx-auto px-4 sm:px-6 py-14">
      ...
      <div className="mt-8 grid md:grid-cols-2 gap-6">
        <div className="rounded-2xl border bg-white p-6 shadow-sm">
          ...
          <div className="mt-2 text-3xl font-extrabold text-gray-900">₹0 <span className="text-base font-medium text-gray-500">/ forever</span></div>
        ...
        <div className="rounded-2xl border-2 border-blue-600 bg-white p-6 shadow">
          ...
          <div className="mt-2 text-3xl font-extrabold text-gray-900">₹299<span className="text-base font-medium text-gray-500">/month</span> <span className="text-sm text-gray-400">or ₹2,999/year</span></div>
          ...
          <ul className="mt-2 space-y-2 text-sm text-gray-700 list-disc list-inside">
            <li>🚀 Unlimited access to the AI Socratic Tutor</li>
    ...
    <div className="container mx-auto px-4 sm:px-6 py-14">
      ...
      <div className="mt-8 space-y-3">
        {[{
          ...
          a: "Currently, Rad Mentor is designed to help you master the vast syllabus for your theory exam. While a strong theoretical foundation is crucial for practicals, we don’t have specific features for case presentations or viva preparation at this time.",
        }, {
